...
if user_menu == 'Medal Tally':
    ...
    if selected_year == 'Overall' and selected_country == 'Overall':
        st.title("Overall Medal Tally Of All Countries")
    if selected_year != 'Overall' and selected_country == 'Overall':
...
if user_menu == 'Athlete-wise Analysis':
    ...
    fig = ff.create_distplot([x1, x2, x3, x4],['Overall Age', 'Gold Medalist Age', 'Silver Medalist Age', 'Bronze Medalist Age'],show_hist=False, show_rug=False)
